...
const (
	...
	ZodiacBlindBox   = "生肖盲盒"
	SubscribeNews    = "订阅新闻"
	UnSubscribeNews  = "退订新闻"
	SubscribeTips    = "订阅摸鱼提醒"
	UnSubscribeTips  = "退订摸鱼提醒"
)
...
const (
	...
	AbilitiesIntroduce              = "你好,我是摸鱼小助手！我的功能如下所示:\n"
	ReplyPre                        = "你想要的是否是:\n"
	...
	Ad                         = "@摸鱼小助手并发送菜单,可以查看小助手更多功能。\n"
	ModeChatSet                = "已切换为%s对话模式"
	ModeImgSet                 = "已切换为%s生图模式"
	DailyProfit                = "昨日收益:\n美团:%.2f元。\n滴滴:%.2f元。\n总收益:%.2f元。"
	SendDailyProfitUser        = "哥哥"
	GroupDrawLotsSuf           = "解@%s的签:\n%s"
	FriendDrawLotsSuf          = "解签:\n%s"
	ZodiacBlindBoxSuf          = "恭喜%s抽中了%s"
	HasDraw                    = "今日已抽过签,请明天再来~"
	HasZodiacBlindBox          = "今日已抽过生肖盲盒,请明天再来~"
	UnHasDrawLots              = "今日还未抽签,请抽签后再进行解签~"
	SubscribeMoyuTipsSuccess   = "订阅摸鱼提醒成功~"
	SubscribeNewsSuccess       = "订阅新闻成功~"
	UnSubscribeMoyuTipsSuccess = "退订摸鱼提醒成功~"
	UnSubscribeNewsSuccess     = "退订新闻成功~"
)
const (
	SignSuccess = 0
	SignFail    = 1
...
const (
	...
	FriendDrawLotsMark       = "friendDrawLots:%s"
